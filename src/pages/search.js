...
class SearchPage extends React.Component {
  ...
  render() {
    ...
    return (
      <Layout title="Search">
        <Loader>
          <Search query={this.state.query} facets={this.state.facets} showThemes={e => this.showThemes(e)} />
          <div className="themes" style={{display: this.state.showThemes ? 'block' : 'none'}}>
            {themeGroups.map(tg => {
