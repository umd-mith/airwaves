  ...
  <div className="page-about">
    <section className="leader">
      ...
      <article id="tech_infrastructure">
        ...
        <p>The application website itself is being generated as a static site using <a href="https://www.gatsbyjs.org/">Gatsby</a>, an open source framework based on <a href="https://reactjs.org/">React</a>, in conjunction with <a href="https://flexsearch.net/">FlexSearch</a>, which indexes the JSON files generated out of a) the Internet Archive (text from OCR derivatives of the scanned images) and b) Airtable (Dublin Core metadata about digitized folders, PBCore metadata about audio, and metadata for Authorities and Series titles).</p>
