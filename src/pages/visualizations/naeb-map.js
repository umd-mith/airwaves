      ...
      <div className="page-visualization-naeb-map">
        <section id="map">
          ...
          <p>
            ...
            information about an organization and a link to that organization's
            landing page on Unlocking the Airwaves, which includes all the
            collection materials the organization created or contributed to. The
            states are shaded to represent their NAEB region, an organizational
            structure within the NAEB that helped geographically close NAEB
            members to meet and collaborate. Pan and zoom around the map using
            your mouse or the tools in the upper left corner.
          </p>
          <IFrame
