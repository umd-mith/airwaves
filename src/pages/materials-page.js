    ...
    <div className="exp-panel">
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          aria-controls="section-summary-content"
          id="section-summary-header"
        >
          <Typography className="section-heading">Summary Information</Typography>
        </ExpansionPanelSummary>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          expandIcon={<ExpandMoreIcon />}
          aria-controls="section-biohist-content"
          id="section-biohist-header"
        >
          <Typography className="section-heading">Biography/History</Typography>
        </ExpansionPanelSummary>
        <ExpansionPanelDetails>
          <Typography className="section-content">
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          expandIcon={<ExpandMoreIcon />}
          aria-controls="section-scope-content"
          id="section-scope-header"
        >
          <Typography className="section-heading">Scope and Content Notes</Typography>
        </ExpansionPanelSummary>
        <ExpansionPanelDetails>
          <Typography className="section-content">
